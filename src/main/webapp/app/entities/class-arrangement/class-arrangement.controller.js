(function() {
    ...
    ClassArrangementController.$inject = ['$state', 'ClassArrangement', 'ParseLinks', 'AlertService', 'paginationConstants', 'pagingParams'];

    function ClassArrangementController($state, ClassArrangement, ParseLinks, AlertService, paginationConstants, pagingParams) {
